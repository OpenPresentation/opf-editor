...
Native Linux CI run `34954891213` at `87bf70a885cb511e0bff57131449181239e16942` now passes the complete package workflow. The retained full log confirms seven JSON workflows from checkout and seven from the coordinated installed consumer, plus the existing ten measured/ten estimated/ten installed rich-input workflows. This closes the CI requirement above for the redo correction; package publication and site package adoption remain separate.
